...
public class AltibaseResultSetTester extends BaseResultSetTester
{
  ...
  private static List<TestColumnDefinition> getListCdSimple()
  {
    ...
    listCdSimple.add(new TestColumnDefinition("CFLOAT_14","FLOAT",Float.valueOf((float)Math.PI)));
  ...
  public void testClass()
  {
    ...
    {
      openResultSet(_sSqlQuerySimple,ResultSet.TYPE_FORWARD_ONLY,ResultSet.CONCUR_READ_ONLY);
      assertEquals("Wrong result set class!", AltibaseResultSet.class, getResultSet().getClass());
    }
    catch(SQLException se) { fail(EU.getExceptionMessage(se)); }
  }
  ...
  public void testGetNClob()
  {
    try
    {
      openResultSet(_sSqlQuerySimple,ResultSet.TYPE_FORWARD_ONLY,ResultSet.CONCUR_READ_ONLY);
      TestColumnDefinition tcd = findColumnDefinition(
              TestSqlDatabase._listCdSimple,"CNCLOB_255");
  ...
  public void testGetSqlXml()
  {
    ...
    catch(SQLException se) { /* Altibase does not support SQLXML */ }
  } /* testGetSqlXml */
  ...
  {
    // altibase double precision diff
  } /* testGetDouble */
...
//    assertEquals("Invalid Timestamp!",tsExpected,ts);
  ...
  {
    // no binaryStream in Altibase varbyte
  } /* testGetBinaryStream */
    ...
    try
    {
      ...
      for (int iColumn = 0; iColumn < TestSqlDatabase._listCdSimple.size(); iColumn++)
      {
                ...
                tcd.getName().equals("CFLOAT_14"))
        {
          ...
          {
            BigDecimal bd = (BigDecimal)o;
            assertEquals("Invalid value for "+tcd.getType()+"!",(Float)tcd.getValue(),bd.floatValue(),0.000001f);
          }
          else
        ...
        else if (tcd.getName().equals("CDOUBLE"))
        {
          ...
          {
            Double d = (Double)o;
            /* Altibase double precisoin diff
               Expected :2.718281828459045
               Actual   :2.7182818284590446
             */
            assertEquals("Invalid value for " + tcd.getType() + "!", (Double)tcd.getValue(), d,0.00000000000001f);
          }
          else
        ...
        else if (tcd.getName().equals("CDATE"))
        {
          ...
          else if (o instanceof Timestamp)
          {
            ...
            assertEquals("Invalid value for "+tcd.getType()+"!",((Date)tcd.getValue()).getTime(),ts.getTime());
          }
          else
        ...
        else if (tcd.getName().equals("CTIME"))
        {
          ...
          {
            assertEquals("Invalid value for "+tcd.getType()+"!",((Time)tcd.getValue()).getTime(),((Timestamp)o).getTime());
          }
          else
  ...
  public void testGetObjectNativeSimple()
  {
    try
    {
      ...
      for (int iColumn = 0; iColumn < TestAltibaseDatabase._listCdSimple.size(); iColumn++)
      {
        TestColumnDefinition tcd = TestAltibaseDatabase._listCdSimple.get(iColumn);
        Object o = getResultSet().getObject(tcd.getName());
        ...
        else if (tcd.getName().equals("CFLOAT_9") ||
                 tcd.getName().equals("CREAL"))
        {
          if (o instanceof Float)
          {
            Float f = (Float)o;
                ...
                tcd.getName().equals("CNCHAR_50"))
        {
          ...
          {
            String s = (String)o;
            if (tcd.getName().equals("CCHAR_4"))
            {
              // Altibase char has trailing spaces
              assertEquals("Invalid value for " + tcd.getType() + "!", (String)tcd.getValue()+" ", s);
            }
            else if (tcd.getName().equals("CNCHAR_50"))
            {
              // Altibase char has trailing spaces
              assertEquals("Invalid value for " + tcd.getType() + "!", (String)tcd.getValue()+"     ", s);
            }
                ...
                tcd.getName().equals("CLONG_VARCHAR"))
        {
          if (o instanceof Clob)
          {
            ...
            fail("Type Clob expected for "+tcd.getType()+"!");
                ...
                tcd.getName().equals("CBYTE") ||
                tcd.getName().equals("CVARBYTE_255") ||
        ...
        else if (tcd.getName().equals("CNVARCHAR_50"))
        {
          assertEquals("Invalid value for "+tcd.getType()+"!",tcd.getValue(),o);
        }
        else
  ...
  public void testGetObjectNativeComplex()
  {
    try
    {
      ...
      for (int iColumn = 0; iColumn < TestAltibaseDatabase._listCdComplex.size(); iColumn++)
      {
        TestColumnDefinition tcd = TestAltibaseDatabase._listCdComplex.get(iColumn);
        Object o = getResultSet().getObject(tcd.getName());
        if (tcd.getName().equals("CID"))
        {
          if (o instanceof Integer)
          {
            ...
            fail("Type Integer expected for "+tcd.getType()+"!");
                ...
                tcd.getName().equals("MULTIPOINT") ||
                tcd.getName().equals("CMULTIPOINT") ||
                ...
                tcd.getName().equals("CSET"))
        {
          ...
          {
            // Altibase Geometry getObject returns byte[]
          }
          else
            fail("Type String expected for "+tcd.getType()+"!");
        }
...
//      getResultSet().updateBlob(tcd.getName(), blob);
      ...
      getResultSet().updateLong(tcd.getName(),((Long)tcd.getValue()).longValue());
      tcd = findColumnDefinition(_listCdSimple,"CFLOAT_14");
      getResultSet().updateFloat(tcd.getName(),((Float)tcd.getValue()).floatValue());
