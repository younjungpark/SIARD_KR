...
public class AltibaseDatabaseMetaDataTester extends BaseDatabaseMetaDataTester
{
  ...
  {
    enter();
    try {	print(_dmdAltibase.getTypeInfo());	}
    catch (SQLException se) {	fail(EU.getExceptionMessage(se));	}
  } /* getTypeInfo */
      ...
      if ((rs != null) && (!rs.isClosed()))
      {
        while (rs.next())
        {
          ...
          switch(sTypeName)
          {
            ...
            case "NCHAR": assertEquals("Invalid nchar mapping!", AltibaseTypes.NCHAR,iDataType); break;
            case "NVARCHAR": assertEquals("Invalid nvarchar mapping!",AltibaseTypes.NVARCHAR,iDataType); break;
            case "BYTE": assertEquals("Invalid byte mapping!",AltibaseTypes.BYTE,iDataType); break;
            case "VARBYTE": assertEquals("Invalid varbyte mapping!",AltibaseTypes.VARBYTE,iDataType); break;
            case "BLOB": assertEquals("Invalid blob mapping!",ColumnTypes.BLOB,iDataType); break;
            case "CLOB": assertEquals("Invalid clob mapping!",ColumnTypes.CLOB,iDataType); break;
            case "INTEGER": assertEquals("Invalid int mapping!",Types.INTEGER,iDataType); break;
            ...
            case "BIT": assertEquals("Invalid bit mapping!",Types.BIT,iDataType); break;
            ...
            case "GEOMETRY": assertEquals("Invalid geometry mapping!",AltibaseTypes.GEOMETRY,iDataType); break;
            default:
  ...
  {
    enter();
    try { print(_dmdAltibase.getTableTypes()); }
    catch(SQLException se) { fail(EU.getExceptionMessage(se)); }
  }
  ...
  {
    enter();
    try { print(_dmdAltibase.getProcedures(null, TestSqlDatabase._sTEST_SCHEMA,"%")); }
    catch(SQLException se) { fail(EU.getExceptionMessage(se)); }
  }
  ...
  {
    enter();
    try { print(_dmdAltibase.getProcedureColumns(null,TestSqlDatabase._sTEST_SCHEMA,"%","%")); }
    catch(SQLException se) { fail(EU.getExceptionMessage(se)); }
  }
  @Test
  @Override
  ...
  {
    enter();
    try { print(_dmdAltibase.getTables(null, TestSqlDatabase._sTEST_SCHEMA, "%", new String[] {"TABLE"})); }
    catch(SQLException se) { fail(EU.getExceptionMessage(se)); }
  }
  @Test
  ...
  {
    enter();
    try { print(_dmdAltibase.getTables(null, TestSqlDatabase._sTEST_SCHEMA, "%", new String[] {"VIEW"})); }
    catch(SQLException se) { fail(EU.getExceptionMessage(se)); }
  }
  ...
  {
    enter();
    try { print(_dmdAltibase.getUDTs(null,"%","%",null)); }
    catch(SQLException se) { /* Altibase does not support UDT */ }
  }
  ...
  {
    enter();
    try { print(_dmdAltibase.getAttributes(null, TestSqlDatabase._sTEST_SCHEMA, "%", "%")); }
    catch(SQLException se) { fail(EU.getExceptionMessage(se)); }
  }
  ...
  public void testGetPrimaryKeys()
  {
    ...
    try { print(_dmdAltibase.getPrimaryKeys(qiTable.getCatalog(),qiTable.getSchema(),qiTable.getName())); }
    catch(SQLException se) { fail(EU.getExceptionMessage(se)); }
  }
  ...
  public void testGetImportedKeys()
  {
    ...
    try { print(_dmdAltibase.getImportedKeys(qiTable.getCatalog(),qiTable.getSchema(),qiTable.getName())); }
    catch(SQLException se) { fail(EU.getExceptionMessage(se)); }
  }
  ...
  public void testGetExportedKeys()
  {
    ...
    try { print(_dmdAltibase.getExportedKeys(qiTable.getCatalog(),qiTable.getSchema(),qiTable.getName())); }
    catch(SQLException se) { fail(EU.getExceptionMessage(se)); }
  }
  ...
  {
    enter();
    try { print(_dmdAltibase.getCrossReference(null,TestSqlDatabase._sTEST_SCHEMA,"%",null,TestSqlDatabase._sTEST_SCHEMA,"%")); }
    catch(SQLException se) { fail(EU.getExceptionMessage(se)); }
  }
  ...
  {
    enter();
    try { print(_dmdAltibase.getColumnPrivileges(null,null,"%","%")); }
  ...
  public void testGetVersionColumns()
  {
    enter();
    QualifiedId qiTable = TestSqlDatabase.getQualifiedSimpleTable();
    try { print(_dmdAltibase.getVersionColumns(
            qiTable.getCatalog(),
            qiTable.getSchema(),
            qiTable.getName())); }
    catch(SQLException se) { fail(EU.getExceptionMessage(se)); }
  ...
  public void testGetBestRowIdentifier()
  {
    enter();
    QualifiedId qiTable = TestSqlDatabase.getQualifiedSimpleTable();
    try { print(_dmdAltibase.getBestRowIdentifier(
            qiTable.getCatalog(),
            qiTable.getSchema(),
            qiTable.getName(),
